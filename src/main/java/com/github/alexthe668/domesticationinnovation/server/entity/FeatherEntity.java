...
public class FeatherEntity extends FishingHook {
    ...
    public FeatherEntity(EntityType<FeatherEntity> featherType, Level level) {
    ...
    public boolean isPetAmbulatory(LivingEntity entity){
        ...
        if(entity instanceof ModifedToBeTameable && ((ModifedToBeTameable) entity).getCommand() == 1 && DomesticationMod.CONFIG.trinaryCommandSystem.get()){
            return false;
        }
        return true;
    }
