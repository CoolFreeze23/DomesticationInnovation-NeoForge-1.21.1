...
public class RottenAppleItem extends Item {
    ...
    public InteractionResult interactLivingEntity(ItemStack stack, Player player, LivingEntity entity, InteractionHand hand) {
        if(entity.getType() == EntityType.HORSE && net.neoforged.neoforge.event.EventHooks.canLivingConvert(entity, EntityType.ZOMBIE_HORSE, (timer) -> {})){
            player.swing(hand);
            ...
            if(!horse.getItemBySlot(EquipmentSlot.BODY).isEmpty()){
                horse.spawnAtLocation(horse.getItemBySlot(EquipmentSlot.BODY).copy());
