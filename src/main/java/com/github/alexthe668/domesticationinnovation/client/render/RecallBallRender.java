...
public class RecallBallRender extends EntityRenderer<RecallBallEntity> {
    ...
    private final RecallBallModel recallBallModel;
    private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(DomesticationMod.MODID, "textures/recall_ball.png");

    public RecallBallRender(EntityRendererProvider.Context renderManagerIn) {
        super(renderManagerIn);
        this.recallBallModel = new RecallBallModel(renderManagerIn.bakeLayer(DIModelLayers.RECALL_BALL));
    }
