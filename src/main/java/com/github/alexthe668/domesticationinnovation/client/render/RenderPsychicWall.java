...
public class RenderPsychicWall extends EntityRenderer<PsychicWallEntity> {
    ...
    private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(DomesticationMod.MODID, "textures/psychic_wall_border.png");
    ...
    private void renderWall(PoseStack matrixStackIn, float size, MultiBufferSource bufferIn, VertexConsumer ivertexbuilder) {
        ...
        this.drawVertex(lvt_20_1_, ivertexbuilder, -1, 0, -1, 0, 0, 1, 0, 1, 240);
        this.drawVertex(lvt_20_1_, ivertexbuilder, -1, 0, 1, 0, size, 1, 0, 1, 240);
        this.drawVertex(lvt_20_1_, ivertexbuilder, 1, 0, 1, size, size, 1, 0, 1, 240);
        this.drawVertex(lvt_20_1_, ivertexbuilder, 1, 0, -1, size, 0, 1, 0, 1, 240);
        matrixStackIn.popPose();
    }

    public void drawVertex(Matrix4f p_229039_1_, VertexConsumer p_229039_3_, int p_229039_4_, int p_229039_5_, int p_229039_6_, float p_229039_7_, float p_229039_8_, int p_229039_9_, int p_229039_10_, int p_229039_11_, int p_229039_12_) {
