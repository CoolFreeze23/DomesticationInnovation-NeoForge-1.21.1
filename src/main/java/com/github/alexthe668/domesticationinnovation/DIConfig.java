...
public class DIConfig {
    ...
    public DIConfig(final ModConfigSpec.Builder builder) {
        ...
        injuredPetsStopFighting = builder.comment("true if badly hurt pets stop engaging hostile mobs and iron golems so they can retreat and heal").define("injured_pets_stop_fighting", true);
        ...
        builder.push("loot");
        petCurseEnchantmentsLootOnly = builder.comment("true if pet curse enchantment books should only appear in loot and not in animal tamer book trades (curses are never available in the enchanting table)").define("pet_curse_enchantments_loot_only", true);
